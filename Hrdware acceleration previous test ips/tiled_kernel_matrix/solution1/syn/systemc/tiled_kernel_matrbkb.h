...
#ifndef __tiled_kernel_matrbkb__HH__
#define __tiled_kernel_matrbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tiled_kernel_matrbkb) {
    ...
    SC_CTOR(tiled_kernel_matrbkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
