...
#ifndef __tiled_kernel_matribs__HH__
#define __tiled_kernel_matribs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tiled_kernel_matribs) {
    ...
    SC_CTOR(tiled_kernel_matribs):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
