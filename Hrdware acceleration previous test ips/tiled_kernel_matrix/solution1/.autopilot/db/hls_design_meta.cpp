...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("kernel_index_stream_TDATA", 32, hls_in, 0, "axis", "in_data", 1),
	Port_Property("kernel_index_stream_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("kernel_index_stream_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
	Port_Property("kernel_index_stream_TKEEP", 4, hls_in, 1, "axis", "in_data", 1),
	Port_Property("kernel_index_stream_TSTRB", 4, hls_in, 2, "axis", "in_data", 1),
	Port_Property("kernel_index_stream_TUSER", 4, hls_in, 3, "axis", "in_data", 1),
	Port_Property("kernel_index_stream_TLAST", 1, hls_in, 4, "axis", "in_data", 1),
	Port_Property("kernel_index_stream_TID", 5, hls_in, 5, "axis", "in_data", 1),
	Port_Property("kernel_index_stream_TDEST", 5, hls_in, 6, "axis", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "tiled_kernel_matrix";
