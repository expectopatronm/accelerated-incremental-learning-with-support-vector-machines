...
set Library     "hls"
set IPName      "predict_tiled"
set Version     "1.0"
set DisplayName "Predict_tiled"
set Revision    "1906172305"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL_BUS predict_in_stream supp_vec_stream dual_coef_stream predict_out_stream"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    predict_out_stream {
        type "axi4stream"
        mode "master"
        port_prefix "predict_out_stream"
        has_tready "1"
        ports {
            TDATA 32
            TDEST 5
