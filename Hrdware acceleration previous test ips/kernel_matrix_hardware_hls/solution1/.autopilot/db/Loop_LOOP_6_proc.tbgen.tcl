...
set portList { 
	...
	{ kernel_out_stream_TVALID sc_out sc_logic 1 outvld 2 } 
	{ kernel_out_stream_TREADY sc_in sc_logic 1 outacc 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "kernel_out_stream_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "kernel_out_stream_data_V", "role": "default" }} , 
 	{ "name": "kernel_out_stream_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "kernel_out_stream_data_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	kernel_out_stream_data_V { axis {  { kernel_out_stream_TDATA out_data 1 32 }  { kernel_out_stream_TVALID out_vld 1 1 }  { kernel_out_stream_TREADY out_acc 0 1 } } }
	...
	kernel_out_stream_dest_V { axis {  { kernel_out_stream_TDEST out_data 1 5 } } }
}
