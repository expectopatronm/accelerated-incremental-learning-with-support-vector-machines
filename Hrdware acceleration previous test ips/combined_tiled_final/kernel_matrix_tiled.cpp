...
//void kernel_matrix(int *length_x_kernel, int *tile_size_kernel, int *remaining_size_kernel, AXI_VAL *kernel_in_stream, AXI_VAL *kernel_index_stream, AXI_VAL *kernel_out_stream){
//
