...
set ArgLastReadFirstWriteLatency {
	accelerator_function {
		...
		remaining_size_kernel {Type I LastRead 2 FirstWrite -1}
		tile_count_predict {Type I LastRead 6 FirstWrite -1}
		remainder_predict {Type I LastRead 7 FirstWrite -1}
		dual_coeff_length {Type I LastRead 5 FirstWrite -1}
		...
		in_stream_predict_data_V {Type I LastRead 5 FirstWrite -1}
		in_stream_predict_keep_V {Type I LastRead 5 FirstWrite -1}
		in_stream_predict_strb_V {Type I LastRead 5 FirstWrite -1}
		in_stream_predict_user_V {Type I LastRead 5 FirstWrite -1}
		in_stream_predict_last_V {Type I LastRead 5 FirstWrite -1}
		in_stream_predict_id_V {Type I LastRead 5 FirstWrite -1}
		in_stream_predict_dest_V {Type I LastRead 5 FirstWrite -1}
		supp_vec_stream_data_V {Type I LastRead 8 FirstWrite -1}
		supp_vec_stream_keep_V {Type I LastRead 8 FirstWrite -1}
		supp_vec_stream_strb_V {Type I LastRead 8 FirstWrite -1}
		supp_vec_stream_user_V {Type I LastRead 8 FirstWrite -1}
		supp_vec_stream_last_V {Type I LastRead 8 FirstWrite -1}
		supp_vec_stream_id_V {Type I LastRead 8 FirstWrite -1}
		supp_vec_stream_dest_V {Type I LastRead 8 FirstWrite -1}
		dual_coef_stream_data_V {Type I LastRead 5 FirstWrite -1}
		dual_coef_stream_keep_V {Type I LastRead 5 FirstWrite -1}
		dual_coef_stream_strb_V {Type I LastRead 5 FirstWrite -1}
		dual_coef_stream_user_V {Type I LastRead 5 FirstWrite -1}
		dual_coef_stream_last_V {Type I LastRead 5 FirstWrite -1}
		dual_coef_stream_id_V {Type I LastRead 5 FirstWrite -1}
		dual_coef_stream_dest_V {Type I LastRead 5 FirstWrite -1}
		out_stream_predict_data_V {Type O LastRead -1 FirstWrite 8}
		out_stream_predict_keep_V {Type O LastRead -1 FirstWrite 8}
		out_stream_predict_strb_V {Type O LastRead -1 FirstWrite 8}
		out_stream_predict_user_V {Type O LastRead -1 FirstWrite 8}
		out_stream_predict_last_V {Type O LastRead -1 FirstWrite 8}
		out_stream_predict_id_V {Type O LastRead -1 FirstWrite 8}
		out_stream_predict_dest_V {Type O LastRead -1 FirstWrite 8}}}
