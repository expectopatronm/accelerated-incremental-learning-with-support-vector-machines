...
#ifndef __accelerator_functg8j__HH__
#define __accelerator_functg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(accelerator_functg8j) {
    ...
    SC_CTOR(accelerator_functg8j):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
