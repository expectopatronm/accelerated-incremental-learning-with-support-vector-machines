...
#ifndef __predict_faddfsub_dEe__HH__
#define __predict_faddfsub_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(predict_faddfsub_dEe) {
    ...
    SC_CTOR(predict_faddfsub_dEe):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
