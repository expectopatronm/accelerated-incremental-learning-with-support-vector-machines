set C_TypeInfoList {{ 
"predict" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"in_stream": [[],{ "pointer": "0"}] }, {"supp_vec_stream": [[],{ "pointer": "0"}] }, {"dual_coef_stream": [[],{ "pointer": "0"}] }, {"out_stream": [[],{ "pointer": "0"}] }, {"length_x": [[],{ "pointer":  {"scalar": "unsigned int"}}] }, {"length_dc": [[],{ "pointer":  {"scalar": "unsigned int"}}] }],[],""], 
"0": [ "AXI_VAL", {"typedef": [[[],"1"],""]}], 
...
set C_modelArgList {
	...
	{ length_dc int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_stream_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in_stream.data.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "length_dc", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "length_dc","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":24}, "offset_end" : {"in":31}} ]}
...
set portList { 
	...
	{ supp_vec_stream_TDATA sc_in sc_lv 32 signal 7 } 
	{ supp_vec_stream_TVALID sc_in sc_logic 1 invld 13 } 
	{ supp_vec_stream_TREADY sc_out sc_logic 1 inacc 13 } 
	{ supp_vec_stream_TKEEP sc_in sc_lv 4 signal 8 } 
	{ supp_vec_stream_TSTRB sc_in sc_lv 4 signal 9 } 
	{ supp_vec_stream_TUSER sc_in sc_lv 4 signal 10 } 
	{ supp_vec_stream_TLAST sc_in sc_lv 1 signal 11 } 
	{ supp_vec_stream_TID sc_in sc_lv 5 signal 12 } 
	{ supp_vec_stream_TDEST sc_in sc_lv 5 signal 13 } 
	{ dual_coef_stream_TDATA sc_in sc_lv 32 signal 14 } 
	{ dual_coef_stream_TVALID sc_in sc_logic 1 invld 20 } 
	{ dual_coef_stream_TREADY sc_out sc_logic 1 inacc 20 } 
	{ dual_coef_stream_TKEEP sc_in sc_lv 4 signal 15 } 
	{ dual_coef_stream_TSTRB sc_in sc_lv 4 signal 16 } 
	{ dual_coef_stream_TUSER sc_in sc_lv 4 signal 17 } 
	{ dual_coef_stream_TLAST sc_in sc_lv 1 signal 18 } 
	{ dual_coef_stream_TID sc_in sc_lv 5 signal 19 } 
	{ dual_coef_stream_TDEST sc_in sc_lv 5 signal 20 } 
	{ out_stream_TDATA sc_out sc_lv 32 signal 21 } 
	{ out_stream_TVALID sc_out sc_logic 1 outvld 27 } 
	{ out_stream_TREADY sc_in sc_logic 1 outacc 27 } 
	{ out_stream_TKEEP sc_out sc_lv 4 signal 22 } 
	{ out_stream_TSTRB sc_out sc_lv 4 signal 23 } 
	{ out_stream_TUSER sc_out sc_lv 4 signal 24 } 
	{ out_stream_TLAST sc_out sc_lv 1 signal 25 } 
	{ out_stream_TID sc_out sc_lv 5 signal 26 } 
	{ out_stream_TDEST sc_out sc_lv 5 signal 27 } 
...
set NewPortList {[ 
	{ "name": "s_axi_CONTROL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "AWADDR" },"address":[{"name":"predict","role":"start","value":"0","valid_bit":"0"},{"name":"predict","role":"continue","value":"0","valid_bit":"4"},{"name":"predict","role":"auto_start","value":"0","valid_bit":"7"},{"name":"length_x","role":"data","value":"16"},{"name":"length_dc","role":"data","value":"24"}] },
	...
	{ "name": "s_axi_CONTROL_BUS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "ARADDR" },"address":[{"name":"predict","role":"start","value":"0","valid_bit":"0"},{"name":"predict","role":"done","value":"0","valid_bit":"1"},{"name":"predict","role":"idle","value":"0","valid_bit":"2"},{"name":"predict","role":"ready","value":"0","valid_bit":"3"},{"name":"predict","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			...
			{"Name" : "length_dc", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.predict_CONTROL_BUS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.input_buf_0_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.supp_vecs_buf_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dual_coef_buf_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.predict_faddfsub_dEe_U1", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.predict_fmul_32nseOg_U2", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.predict_fexp_32nsfYi_U3", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	predict {
		in_stream_data_V {Type I LastRead 2 FirstWrite -1}
		in_stream_keep_V {Type I LastRead 2 FirstWrite -1}
		in_stream_strb_V {Type I LastRead 2 FirstWrite -1}
		in_stream_user_V {Type I LastRead 2 FirstWrite -1}
		in_stream_last_V {Type I LastRead 2 FirstWrite -1}
		in_stream_id_V {Type I LastRead 2 FirstWrite -1}
		in_stream_dest_V {Type I LastRead 2 FirstWrite -1}
		supp_vec_stream_data_V {Type I LastRead 3 FirstWrite -1}
		supp_vec_stream_keep_V {Type I LastRead 3 FirstWrite -1}
		supp_vec_stream_strb_V {Type I LastRead 3 FirstWrite -1}
		supp_vec_stream_user_V {Type I LastRead 3 FirstWrite -1}
		supp_vec_stream_last_V {Type I LastRead 3 FirstWrite -1}
		supp_vec_stream_id_V {Type I LastRead 3 FirstWrite -1}
		supp_vec_stream_dest_V {Type I LastRead 3 FirstWrite -1}
		dual_coef_stream_data_V {Type I LastRead 3 FirstWrite -1}
		dual_coef_stream_keep_V {Type I LastRead 3 FirstWrite -1}
		dual_coef_stream_strb_V {Type I LastRead 3 FirstWrite -1}
		dual_coef_stream_user_V {Type I LastRead 3 FirstWrite -1}
		dual_coef_stream_last_V {Type I LastRead 3 FirstWrite -1}
		dual_coef_stream_id_V {Type I LastRead 3 FirstWrite -1}
		dual_coef_stream_dest_V {Type I LastRead 3 FirstWrite -1}
		...
		length_dc {Type I LastRead 2 FirstWrite -1}}}
