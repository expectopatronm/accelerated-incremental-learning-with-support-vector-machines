...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL_BUS in_stream kernel_index_stream supp_vec_stream dual_coef_stream out_stream"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
