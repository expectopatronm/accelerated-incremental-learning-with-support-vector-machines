...
#ifndef __hardware_accelerag8j__HH__
#define __hardware_accelerag8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hardware_accelerag8j) {
    ...
    SC_CTOR(hardware_accelerag8j):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
