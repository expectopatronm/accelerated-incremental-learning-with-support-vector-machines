set C_TypeInfoList {{ 
"hardware_accelerator" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"function_flag": [[],{ "pointer":  {"scalar": "unsigned int"}}] }, {"length_x": [[],{ "pointer":  {"scalar": "unsigned int"}}] }, {"tile_count": [[],{ "pointer":  {"scalar": "unsigned int"}}] }, {"dual_coeff_length": [[],{ "pointer":  {"scalar": "unsigned int"}}] }, {"remainder": [[],{ "pointer":  {"scalar": "unsigned int"}}] }, {"in_stream": [[],{ "pointer": "0"}] }, {"kernel_index_stream": [[],{ "pointer": "0"}] }, {"supp_vec_stream": [[],{ "pointer": "0"}] }, {"dual_coef_stream": [[],{ "pointer": "0"}] }, {"out_stream": [[],{ "pointer": "0"}] }],[],""], 
"0": [ "AXI_VAL", {"typedef": [[[],"1"],""]}], 
...
set C_modelArgMapList {[ 
	{ "Name" : "function_flag", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "function_flag","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	...
 	{ "Name" : "tile_count", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "tile_count","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":32}, "offset_end" : {"in":39}} , 
 	{ "Name" : "dual_coeff_length", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "dual_coeff_length","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":40}, "offset_end" : {"in":47}} , 
 	{ "Name" : "remainder", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "remainder","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":48}, "offset_end" : {"in":55}} , 
...
set portList { 
	...
	{ in_stream_TDATA sc_in sc_lv 32 signal 5 } 
	{ in_stream_TVALID sc_in sc_logic 1 invld 11 } 
	{ in_stream_TREADY sc_out sc_logic 1 inacc 11 } 
	{ in_stream_TKEEP sc_in sc_lv 4 signal 6 } 
	{ in_stream_TSTRB sc_in sc_lv 4 signal 7 } 
	{ in_stream_TUSER sc_in sc_lv 4 signal 8 } 
	{ in_stream_TLAST sc_in sc_lv 1 signal 9 } 
	{ in_stream_TID sc_in sc_lv 5 signal 10 } 
	{ in_stream_TDEST sc_in sc_lv 5 signal 11 } 
	{ kernel_index_stream_TDATA sc_in sc_lv 32 signal 12 } 
	{ kernel_index_stream_TVALID sc_in sc_logic 1 invld 18 } 
	{ kernel_index_stream_TREADY sc_out sc_logic 1 inacc 18 } 
	{ kernel_index_stream_TKEEP sc_in sc_lv 4 signal 13 } 
	{ kernel_index_stream_TSTRB sc_in sc_lv 4 signal 14 } 
	{ kernel_index_stream_TUSER sc_in sc_lv 4 signal 15 } 
	{ kernel_index_stream_TLAST sc_in sc_lv 1 signal 16 } 
	{ kernel_index_stream_TID sc_in sc_lv 5 signal 17 } 
	{ kernel_index_stream_TDEST sc_in sc_lv 5 signal 18 } 
	{ supp_vec_stream_TDATA sc_in sc_lv 32 signal 19 } 
	{ supp_vec_stream_TVALID sc_in sc_logic 1 invld 25 } 
	{ supp_vec_stream_TREADY sc_out sc_logic 1 inacc 25 } 
	{ supp_vec_stream_TKEEP sc_in sc_lv 4 signal 20 } 
	{ supp_vec_stream_TSTRB sc_in sc_lv 4 signal 21 } 
	{ supp_vec_stream_TUSER sc_in sc_lv 4 signal 22 } 
	{ supp_vec_stream_TLAST sc_in sc_lv 1 signal 23 } 
	{ supp_vec_stream_TID sc_in sc_lv 5 signal 24 } 
	{ supp_vec_stream_TDEST sc_in sc_lv 5 signal 25 } 
	{ dual_coef_stream_TDATA sc_in sc_lv 32 signal 26 } 
	{ dual_coef_stream_TVALID sc_in sc_logic 1 invld 32 } 
	{ dual_coef_stream_TREADY sc_out sc_logic 1 inacc 32 } 
	{ dual_coef_stream_TKEEP sc_in sc_lv 4 signal 27 } 
	{ dual_coef_stream_TSTRB sc_in sc_lv 4 signal 28 } 
	{ dual_coef_stream_TUSER sc_in sc_lv 4 signal 29 } 
	{ dual_coef_stream_TLAST sc_in sc_lv 1 signal 30 } 
	{ dual_coef_stream_TID sc_in sc_lv 5 signal 31 } 
	{ dual_coef_stream_TDEST sc_in sc_lv 5 signal 32 } 
	{ out_stream_TDATA sc_out sc_lv 32 signal 33 } 
	{ out_stream_TVALID sc_out sc_logic 1 outvld 39 } 
	{ out_stream_TREADY sc_in sc_logic 1 outacc 39 } 
	{ out_stream_TKEEP sc_out sc_lv 4 signal 34 } 
	{ out_stream_TSTRB sc_out sc_lv 4 signal 35 } 
	{ out_stream_TUSER sc_out sc_lv 4 signal 36 } 
	{ out_stream_TLAST sc_out sc_lv 1 signal 37 } 
	{ out_stream_TID sc_out sc_lv 5 signal 38 } 
	{ out_stream_TDEST sc_out sc_lv 5 signal 39 } 
...
set NewPortList {[ 
	{ "name": "s_axi_CONTROL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "AWADDR" },"address":[{"name":"hardware_accelerator","role":"start","value":"0","valid_bit":"0"},{"name":"hardware_accelerator","role":"continue","value":"0","valid_bit":"4"},{"name":"hardware_accelerator","role":"auto_start","value":"0","valid_bit":"7"},{"name":"function_flag","role":"data","value":"16"},{"name":"length_x","role":"data","value":"24"},{"name":"tile_count","role":"data","value":"32"},{"name":"dual_coeff_length","role":"data","value":"40"},{"name":"remainder","role":"data","value":"48"}] },
	...
	{ "name": "s_axi_CONTROL_BUS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "ARADDR" },"address":[{"name":"hardware_accelerator","role":"start","value":"0","valid_bit":"0"},{"name":"hardware_accelerator","role":"done","value":"0","valid_bit":"1"},{"name":"hardware_accelerator","role":"idle","value":"0","valid_bit":"2"},{"name":"hardware_accelerator","role":"ready","value":"0","valid_bit":"3"},{"name":"hardware_accelerator","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.hardware_accelerator_CONTROL_BUS_s_axi_U", "Parent" : "0"},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.index_buf_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.result_buf_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.hardware_accelerag8j_U1", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.hardware_accelerahbi_U2", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.hardware_acceleraibs_U3", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.hardware_accelerajbC_U4", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.hardware_accelerakbM_U5", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.hardware_acceleralbW_U6", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	hardware_accelerator {
		...
		tile_count {Type I LastRead 0 FirstWrite -1}
		dual_coeff_length {Type I LastRead 2 FirstWrite -1}
		remainder {Type I LastRead 0 FirstWrite -1}
		in_stream_data_V {Type I LastRead 2082 FirstWrite -1}
		in_stream_keep_V {Type I LastRead 2082 FirstWrite -1}
		in_stream_strb_V {Type I LastRead 2082 FirstWrite -1}
		in_stream_user_V {Type I LastRead 2082 FirstWrite -1}
		in_stream_last_V {Type I LastRead 2082 FirstWrite -1}
		in_stream_id_V {Type I LastRead 2082 FirstWrite -1}
		in_stream_dest_V {Type I LastRead 2082 FirstWrite -1}
		...
		supp_vec_stream_data_V {Type I LastRead 5 FirstWrite -1}
		supp_vec_stream_keep_V {Type I LastRead 5 FirstWrite -1}
		supp_vec_stream_strb_V {Type I LastRead 5 FirstWrite -1}
		supp_vec_stream_user_V {Type I LastRead 5 FirstWrite -1}
		supp_vec_stream_last_V {Type I LastRead 5 FirstWrite -1}
		supp_vec_stream_id_V {Type I LastRead 5 FirstWrite -1}
		supp_vec_stream_dest_V {Type I LastRead 5 FirstWrite -1}
		...
		out_stream_keep_V {Type O LastRead -1 FirstWrite 4}
		out_stream_strb_V {Type O LastRead -1 FirstWrite 4}
		out_stream_user_V {Type O LastRead -1 FirstWrite 4}
		out_stream_last_V {Type O LastRead -1 FirstWrite 4}
		out_stream_id_V {Type O LastRead -1 FirstWrite 4}
		out_stream_dest_V {Type O LastRead -1 FirstWrite 4}}}
