...
#ifndef __accelerator_functmb6__HH__
#define __accelerator_functmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(accelerator_functmb6) {
    ...
    SC_CTOR(accelerator_functmb6):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
