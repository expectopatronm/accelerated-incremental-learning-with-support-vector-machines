...
#ifndef __accelerator_functncg__HH__
#define __accelerator_functncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(accelerator_functncg) {
    ...
    SC_CTOR(accelerator_functncg):  ACMP_smul_us_U ("ACMP_smul_us_U") {
