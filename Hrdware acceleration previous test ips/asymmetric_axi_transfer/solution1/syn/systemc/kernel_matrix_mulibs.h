...
#ifndef __kernel_matrix_mulibs__HH__
#define __kernel_matrix_mulibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_matrix_mulibs) {
    ...
    SC_CTOR(kernel_matrix_mulibs):  ACMP_smul_us_U ("ACMP_smul_us_U") {
