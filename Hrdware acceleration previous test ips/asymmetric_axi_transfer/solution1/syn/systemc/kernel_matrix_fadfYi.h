...
#ifndef __kernel_matrix_fadfYi__HH__
#define __kernel_matrix_fadfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_matrix_fadfYi) {
    ...
    SC_CTOR(kernel_matrix_fadfYi):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
