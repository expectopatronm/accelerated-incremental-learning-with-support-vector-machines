set C_TypeInfoList {{ 
"kernel_matrix_tiled" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"kernel_in_stream": [[],{ "pointer": "0"}] }, {"kernel_index_stream": [[],{ "pointer": "0"}] }, {"kernel_out_stream": [[],{ "pointer": "0"}] }, {"length_x": [[],{ "pointer":  {"scalar": "unsigned int"}}] }],[],""], 
"0": [ "AXI_VAL", {"typedef": [[[],"1"],""]}], 
...
set moduleName kernel_matrix_tiled
...
set C_modelName {kernel_matrix_tiled}
...
set portList { 
	...
	{ kernel_in_stream_TDATA sc_in sc_lv 32 signal 0 } 
	{ kernel_in_stream_TVALID sc_in sc_logic 1 invld 6 } 
	{ kernel_in_stream_TREADY sc_out sc_logic 1 inacc 6 } 
	{ kernel_in_stream_TKEEP sc_in sc_lv 4 signal 1 } 
	{ kernel_in_stream_TSTRB sc_in sc_lv 4 signal 2 } 
	{ kernel_in_stream_TUSER sc_in sc_lv 4 signal 3 } 
	{ kernel_in_stream_TLAST sc_in sc_lv 1 signal 4 } 
	{ kernel_in_stream_TID sc_in sc_lv 5 signal 5 } 
	{ kernel_in_stream_TDEST sc_in sc_lv 5 signal 6 } 
	{ kernel_index_stream_TDATA sc_in sc_lv 32 signal 7 } 
	{ kernel_index_stream_TVALID sc_in sc_logic 1 invld 13 } 
	{ kernel_index_stream_TREADY sc_out sc_logic 1 inacc 13 } 
	{ kernel_index_stream_TKEEP sc_in sc_lv 4 signal 8 } 
	{ kernel_index_stream_TSTRB sc_in sc_lv 4 signal 9 } 
	{ kernel_index_stream_TUSER sc_in sc_lv 4 signal 10 } 
	{ kernel_index_stream_TLAST sc_in sc_lv 1 signal 11 } 
	{ kernel_index_stream_TID sc_in sc_lv 5 signal 12 } 
	{ kernel_index_stream_TDEST sc_in sc_lv 5 signal 13 } 
...
set NewPortList {[ 
	{ "name": "s_axi_CONTROL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "AWADDR" },"address":[{"name":"kernel_matrix_tiled","role":"start","value":"0","valid_bit":"0"},{"name":"kernel_matrix_tiled","role":"continue","value":"0","valid_bit":"4"},{"name":"kernel_matrix_tiled","role":"auto_start","value":"0","valid_bit":"7"},{"name":"length_x","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_CONTROL_BUS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "ARADDR" },"address":[{"name":"kernel_matrix_tiled","role":"start","value":"0","valid_bit":"0"},{"name":"kernel_matrix_tiled","role":"done","value":"0","valid_bit":"1"},{"name":"kernel_matrix_tiled","role":"idle","value":"0","valid_bit":"2"},{"name":"kernel_matrix_tiled","role":"ready","value":"0","valid_bit":"3"},{"name":"kernel_matrix_tiled","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_matrix_tiled_CONTROL_BUS_s_axi_U", "Parent" : "0"},
	...
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_matrix_tilfYi_U1", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_matrix_tilg8j_U2", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_matrix_tilhbi_U3", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_matrix_tilibs_U4", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_matrix_tiljbC_U5", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	kernel_matrix_tiled {
		kernel_in_stream_data_V {Type I LastRead 41 FirstWrite -1}
		kernel_in_stream_keep_V {Type I LastRead 41 FirstWrite -1}
		kernel_in_stream_strb_V {Type I LastRead 41 FirstWrite -1}
		kernel_in_stream_user_V {Type I LastRead 41 FirstWrite -1}
		kernel_in_stream_last_V {Type I LastRead 41 FirstWrite -1}
		kernel_in_stream_id_V {Type I LastRead 41 FirstWrite -1}
		kernel_in_stream_dest_V {Type I LastRead 41 FirstWrite -1}
		kernel_index_stream_data_V {Type I LastRead 37 FirstWrite -1}
		kernel_index_stream_keep_V {Type I LastRead 37 FirstWrite -1}
		kernel_index_stream_strb_V {Type I LastRead 37 FirstWrite -1}
		kernel_index_stream_user_V {Type I LastRead 37 FirstWrite -1}
		kernel_index_stream_last_V {Type I LastRead 37 FirstWrite -1}
		kernel_index_stream_id_V {Type I LastRead 37 FirstWrite -1}
		kernel_index_stream_dest_V {Type I LastRead 37 FirstWrite -1}
		kernel_out_stream_data_V {Type O LastRead -1 FirstWrite 40}
		kernel_out_stream_keep_V {Type O LastRead -1 FirstWrite 40}
		kernel_out_stream_strb_V {Type O LastRead -1 FirstWrite 40}
		kernel_out_stream_user_V {Type O LastRead -1 FirstWrite 40}
		kernel_out_stream_last_V {Type O LastRead -1 FirstWrite 40}
		kernel_out_stream_id_V {Type O LastRead -1 FirstWrite 40}
		kernel_out_stream_dest_V {Type O LastRead -1 FirstWrite 40}
