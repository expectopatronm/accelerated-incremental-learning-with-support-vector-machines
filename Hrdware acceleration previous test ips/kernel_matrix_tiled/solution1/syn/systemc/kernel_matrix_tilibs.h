...
#ifndef __kernel_matrix_tilibs__HH__
#define __kernel_matrix_tilibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_matrix_tilibs) {
    ...
    SC_CTOR(kernel_matrix_tilibs):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
