...
#ifndef __kernel_matrix_tiljbC__HH__
#define __kernel_matrix_tiljbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_matrix_tiljbC) {
    ...
    SC_CTOR(kernel_matrix_tiljbC):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
