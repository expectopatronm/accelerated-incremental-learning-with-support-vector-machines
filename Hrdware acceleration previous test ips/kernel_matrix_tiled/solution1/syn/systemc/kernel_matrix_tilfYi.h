...
#ifndef __kernel_matrix_tilfYi__HH__
#define __kernel_matrix_tilfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_matrix_tilfYi) {
    ...
    SC_CTOR(kernel_matrix_tilfYi):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
