...
// ==============================================================
#ifndef __kernel_matrix_fpefYi__HH__
#define __kernel_matrix_fpefYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_matrix_fpefYi) {
    ...
    SC_CTOR(kernel_matrix_fpefYi):  ACMP_fpext_U ("ACMP_fpext_U") {
