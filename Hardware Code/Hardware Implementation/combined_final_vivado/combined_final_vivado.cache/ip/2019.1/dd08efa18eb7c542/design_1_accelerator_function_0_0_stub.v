...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_CONTROL_BUS_AWADDR, 
  ...
  kernel_in_stream_TREADY, kernel_in_stream_TDATA, kernel_in_stream_TDEST, 
  kernel_in_stream_TKEEP, kernel_in_stream_TSTRB, kernel_in_stream_TUSER, 
  kernel_in_stream_TLAST, kernel_in_stream_TID, kernel_index_stream_TVALID, 
  kernel_index_stream_TREADY, kernel_index_stream_TDATA, kernel_index_stream_TDEST, 
  kernel_index_stream_TKEEP, kernel_index_stream_TSTRB, kernel_index_stream_TUSER, 
  kernel_index_stream_TLAST, kernel_index_stream_TID, kernel_out_stream_TVALID, 
  kernel_out_stream_TREADY, kernel_out_stream_TDATA, kernel_out_stream_TDEST, 
  kernel_out_stream_TKEEP, kernel_out_stream_TSTRB, kernel_out_stream_TUSER, 
  kernel_out_stream_TLAST, kernel_out_stream_TID, in_stream_predict_TVALID, 
  in_stream_predict_TREADY, in_stream_predict_TDATA, in_stream_predict_TDEST, 
  in_stream_predict_TKEEP, in_stream_predict_TSTRB, in_stream_predict_TUSER, 
  in_stream_predict_TLAST, in_stream_predict_TID, supp_vec_stream_TVALID, 
  supp_vec_stream_TREADY, supp_vec_stream_TDATA, supp_vec_stream_TDEST, 
  supp_vec_stream_TKEEP, supp_vec_stream_TSTRB, supp_vec_stream_TUSER, 
  supp_vec_stream_TLAST, supp_vec_stream_TID, dual_coef_stream_TVALID, 
  dual_coef_stream_TREADY, dual_coef_stream_TDATA, dual_coef_stream_TDEST, 
  dual_coef_stream_TKEEP, dual_coef_stream_TSTRB, dual_coef_stream_TUSER, 
  dual_coef_stream_TLAST, dual_coef_stream_TID, out_stream_predict_TVALID, 
  out_stream_predict_TREADY, out_stream_predict_TDATA, out_stream_predict_TDEST, 
  out_stream_predict_TKEEP, out_stream_predict_TSTRB, out_stream_predict_TUSER, 
  out_stream_predict_TLAST, out_stream_predict_TID)
/* synthesis syn_black_box black_box_pad_pin="s_axi_CONTROL_BUS_AWADDR[6:0],s_axi_CONTROL_BUS_AWVALID,s_axi_CONTROL_BUS_AWREADY,s_axi_CONTROL_BUS_WDATA[31:0],s_axi_CONTROL_BUS_WSTRB[3:0],s_axi_CONTROL_BUS_WVALID,s_axi_CONTROL_BUS_WREADY,s_axi_CONTROL_BUS_BRESP[1:0],s_axi_CONTROL_BUS_BVALID,s_axi_CONTROL_BUS_BREADY,s_axi_CONTROL_BUS_ARADDR[6:0],s_axi_CONTROL_BUS_ARVALID,s_axi_CONTROL_BUS_ARREADY,s_axi_CONTROL_BUS_RDATA[31:0],s_axi_CONTROL_BUS_RRESP[1:0],s_axi_CONTROL_BUS_RVALID,s_axi_CONTROL_BUS_RREADY,ap_clk,ap_rst_n,interrupt,kernel_in_stream_TVALID,kernel_in_stream_TREADY,kernel_in_stream_TDATA[31:0],kernel_in_stream_TDEST[4:0],kernel_in_stream_TKEEP[3:0],kernel_in_stream_TSTRB[3:0],kernel_in_stream_TUSER[3:0],kernel_in_stream_TLAST[0:0],kernel_in_stream_TID[4:0],kernel_index_stream_TVALID,kernel_index_stream_TREADY,kernel_index_stream_TDATA[31:0],kernel_index_stream_TDEST[4:0],kernel_index_stream_TKEEP[3:0],kernel_index_stream_TSTRB[3:0],kernel_index_stream_TUSER[3:0],kernel_index_stream_TLAST[0:0],kernel_index_stream_TID[4:0],kernel_out_stream_TVALID,kernel_out_stream_TREADY,kernel_out_stream_TDATA[31:0],kernel_out_stream_TDEST[4:0],kernel_out_stream_TKEEP[3:0],kernel_out_stream_TSTRB[3:0],kernel_out_stream_TUSER[3:0],kernel_out_stream_TLAST[0:0],kernel_out_stream_TID[4:0],in_stream_predict_TVALID,in_stream_predict_TREADY,in_stream_predict_TDATA[31:0],in_stream_predict_TDEST[4:0],in_stream_predict_TKEEP[3:0],in_stream_predict_TSTRB[3:0],in_stream_predict_TUSER[3:0],in_stream_predict_TLAST[0:0],in_stream_predict_TID[4:0],supp_vec_stream_TVALID,supp_vec_stream_TREADY,supp_vec_stream_TDATA[31:0],supp_vec_stream_TDEST[4:0],supp_vec_stream_TKEEP[3:0],supp_vec_stream_TSTRB[3:0],supp_vec_stream_TUSER[3:0],supp_vec_stream_TLAST[0:0],supp_vec_stream_TID[4:0],dual_coef_stream_TVALID,dual_coef_stream_TREADY,dual_coef_stream_TDATA[31:0],dual_coef_stream_TDEST[4:0],dual_coef_stream_TKEEP[3:0],dual_coef_stream_TSTRB[3:0],dual_coef_stream_TUSER[3:0],dual_coef_stream_TLAST[0:0],dual_coef_stream_TID[4:0],out_stream_predict_TVALID,out_stream_predict_TREADY,out_stream_predict_TDATA[31:0],out_stream_predict_TDEST[4:0],out_stream_predict_TKEEP[3:0],out_stream_predict_TSTRB[3:0],out_stream_predict_TUSER[3:0],out_stream_predict_TLAST[0:0],out_stream_predict_TID[4:0]" */;
