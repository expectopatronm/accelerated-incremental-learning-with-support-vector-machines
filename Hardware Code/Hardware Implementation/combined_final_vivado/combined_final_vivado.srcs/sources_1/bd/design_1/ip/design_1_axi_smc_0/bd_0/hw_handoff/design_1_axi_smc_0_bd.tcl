...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk_net [get_bd_pins M00_ACLK] [get_bd_pins M01_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins S01_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins S03_ACLK] [get_bd_pins S04_ACLK] [get_bd_pins S05_ACLK] [get_bd_pins S06_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins M01_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins S03_ARESETN] [get_bd_pins S04_ARESETN] [get_bd_pins S05_ARESETN] [get_bd_pins S06_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI:M01_AXI:S00_AXI:S01_AXI:S02_AXI:S03_AXI:S04_AXI:S05_AXI:S06_AXI} \
 ] $aclk
  ...
  connect_bd_intf_net -intf_net S_SC_AW_2 [get_bd_intf_pins s06_axi2sc/M_SC_AW] [get_bd_intf_pins s06_nodes/S_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_2 [get_bd_intf_pins s06_nodes/S_SC_B] [get_bd_intf_pins switchboards/M06_SC_B]
  ...
  connect_bd_intf_net -intf_net S_SC_W_2 [get_bd_intf_pins s06_axi2sc/M_SC_W] [get_bd_intf_pins s06_nodes/S_SC_W]
