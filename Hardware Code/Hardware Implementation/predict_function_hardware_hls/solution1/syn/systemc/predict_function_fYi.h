...
// ==============================================================
#ifndef __predict_function_fYi__HH__
#define __predict_function_fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(predict_function_fYi) {
    ...
    SC_CTOR(predict_function_fYi):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
