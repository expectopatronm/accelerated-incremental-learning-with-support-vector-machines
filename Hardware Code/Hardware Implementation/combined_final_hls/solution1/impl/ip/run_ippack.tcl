...
set Library     "hls"
set IPName      "accelerator_function"
set Version     "1.0"
set DisplayName "Accelerator_function"
set Revision    "1907091910"
...
set sdx_kernel_name "accelerator_function"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "F:/Hardware_Implementation/combined_final_hls/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {accelerator_functg8j
...
## Variables
set Top "accelerator_function"
set TopNoPrefix "accelerator_function"
...
set Interfaces {
    s_axi_CONTROL_BUS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 function_flag W 0x0 "Data signal of function_flag" {{0 32 function_flag W 0 "Bit 31 to 0 Data signal of function_flag"}}} {0x18 length_x_kernel W 0x0 "Data signal of length_x_kernel" {{0 32 length_x_kernel W 0 "Bit 31 to 0 Data signal of length_x_kernel"}}} {0x20 tile_size_kernel W 0x0 "Data signal of tile_size_kernel" {{0 32 tile_size_kernel W 0 "Bit 31 to 0 Data signal of tile_size_kernel"}}} {0x28 remaining_size_kernel W 0x0 "Data signal of remaining_size_kernel" {{0 32 remaining_size_kernel W 0 "Bit 31 to 0 Data signal of remaining_size_kernel"}}} {0x30 tile_count_predict W 0x0 "Data signal of tile_count_predict" {{0 32 tile_count_predict W 0 "Bit 31 to 0 Data signal of tile_count_predict"}}} {0x38 remainder_predict W 0x0 "Data signal of remainder_predict" {{0 32 remainder_predict W 0 "Bit 31 to 0 Data signal of remainder_predict"}}} {0x40 dual_coeff_length W 0x0 "Data signal of dual_coeff_length" {{0 32 dual_coeff_length W 0 "Bit 31 to 0 Data signal of dual_coeff_length"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL_BUS kernel_in_stream kernel_index_stream kernel_out_stream in_stream_predict supp_vec_stream dual_coef_stream out_stream_predict"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    kernel_index_stream {
        type "axi4stream"
        mode "slave"
        port_prefix "kernel_index_stream"
        has_tready "1"
        ports {
            TDATA 32
            TKEEP 4
    ...
    out_stream_predict {
        type "axi4stream"
        mode "master"
        port_prefix "out_stream_predict"
        has_tready "1"
        ports {
            TDATA 32
            TKEEP 4
